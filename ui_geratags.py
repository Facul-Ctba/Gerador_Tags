...
from PySide6.QtWidgets import (QAbstractItemView, QAbstractScrollArea, QFrame,
                               ...
                               QMenu, QMenuBar, QPushButton, QStatusBar,
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lb_logo.setAlignment(Qt.AlignLeading | Qt.AlignLeft | Qt.AlignTop)
        ...
        self.lw_arquivos.setItemAlignment(Qt.AlignLeading)
        ...
        self.verticalLayout_2.addWidget(self.tw_tabela)

        self.pb_excl_sel = QPushButton(self.fr_direita)
        self.pb_excl_sel.setObjectName(u"pb_excl_sel")
        self.pb_excl_sel.setMinimumSize(QSize(200, 30))
        self.pb_excl_sel.setMaximumSize(QSize(200, 30))
        self.pb_excl_sel.setCursor(QCursor(Qt.PointingHandCursor))
        self.pb_excl_sel.setStyleSheet(u"QPushButton:hover{\n"
                                       "	background-color: rgb(255, 0, 0);\n"
                                       "	color: rgb(255, 255, 255);\n"
                                       "	border-radius: 10px\n"
                                       "}")

        self.verticalLayout_2.addWidget(self.pb_excl_sel, 0, Qt.AlignHCenter)
...
# endif // QT_CONFIG(shortcut)
        QWidget.setTabOrder(self.le_arquivo, self.le_tag)
        QWidget.setTabOrder(self.le_tag, self.le_quant)
        QWidget.setTabOrder(self.le_quant, self.lw_arquivos)
        QWidget.setTabOrder(self.lw_arquivos, self.tw_tabela)
...
# endif // QT_CONFIG(shortcut)
        self.lb_logo.setText(QCoreApplication.translate(
            "MainWindow", u"<html><head/><body><p align=\"center\"><img src=\":/Gerador_Tags/Avitech_m.png\"/></p></body></html>", None))
        self.lb_titulo.setText(QCoreApplication.translate(
            "MainWindow", u"<html><head/><body><p align=\"center\"><span style=\" font-size:14pt; font-weight:700;\">Programa Gerador de Tags</span></p></body></html>", None))
        ...
        self.lb_recentes.setText(QCoreApplication.translate(
            "MainWindow", u"<html><head/><body><p align=\"center\">Arquivos Recentes</p></body></html>", None))
        ___qtablewidgetitem = self.tw_tabela.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(
            QCoreApplication.translate("MainWindow", u"TAG", None))
        self.pb_excl_sel.setText(QCoreApplication.translate(
            "MainWindow", u"Excluir Sele\u00e7\u00e3o", None))
